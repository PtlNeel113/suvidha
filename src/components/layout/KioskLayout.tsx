...
import { Settings, Phone, HelpCircle, Moon, Sun } from "lucide-react";
        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-3">
              <img src="/logo.png" alt="SUVIDHA Logo"
                className="w-14 h-14 rounded-xl object-contain bg-white p-1 shadow-md border-2 border-white/50" />
              <div>
                <h1 className="font-heading text-xl font-bold tracking-wide">{t("govt_of_india")}</h1>
                <p className="text-secondary-foreground/80 text-sm">{t("digital_suvidha")}</p>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end" className="w-48 max-h-80 overflow-y-auto">
                {languages.map((l) => (
                  <DropdownMenuItem key={l.code} onClick={() => setLang(l.code)} className="touch-target">
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end">
                ...
                <DropdownMenuItem className="touch-target">Accessibility Options</DropdownMenuItem>
              </DropdownMenuContent>
            </DropdownMenu>
          </div>
        </div>
